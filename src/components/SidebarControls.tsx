  ...
  return (
    <div className="w-full lg:w-[410px] shrink-0 bg-slate-50 text-slate-800 flex flex-col h-full lg:h-[calc(100vh-2rem)] border-r border-slate-200 shadow-2xl no-print relative font-sans">
        ...
        {activeTab !== 'index' && (
          <div className="border border-slate-200 rounded-2xl overflow-hidden bg-white shadow-sm">
            ...
            {openSection === 'student' && (
              <div className="p-4 border-t border-slate-100 space-y-3.5 bg-slate-50/40">
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 mb-1">Student's Full Name</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="block text-[11px] font-bold text-slate-500 mb-1">Student ID</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 mb-1">Student Department (Pick or write custom)</label>
                  <input
                    type="text"
                    list="student-depts"
      ...
      <div className="p-5 border-t border-slate-200 bg-white shadow-[0_-5px_15px_rgba(0,0,0,0.02)] space-y-2">
        ...
        >
          <span>Open Browser Print Dialogue</span>
        </button>
